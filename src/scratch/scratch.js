...
//             if(!self.completed){
//                 var cleardPercent = calcClearedPercent(context, region, self.checkArea);
//                 if(config.onProgress) config.onProgress(cleardPercent);
//                 if(cleardPercent < config.thresholdPercent) return;
//                 self.ready = false;
//                 self.completed = true;
...
//                 if(config.drawCoverImage){
//                     config.drawCoverImage(context, image);
//                 }else{
...
//         var rects = [], i, left, top, width, height, rect;
